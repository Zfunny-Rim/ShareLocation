		...
		<div class="sidebar-menu">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="password" class="form-control"
											placeholder="Password" id="password_check" name="password">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-12">
			...
			<ul class="menu">
				...
				<li class="sidebar-item"><a href="/sharelocation"
					class='sidebar-link'> <i class="bi bi-house-door-fill"></i> <span>홈</span>
				</a></li>
				<li class="sidebar-item"><a href="reservList.rv"
					class='sidebar-link'> <i class="bi bi-journal-text"></i> <span>예약리스트
							보기</span>
				</a></li>
				<li class="sidebar-item"><a href="favoriteList.sp"
					class='sidebar-link'> <i class="bi bi-bookmark-star-fill"></i>
						<span>찜한 공간</span>
				</a></li>
				<li class="sidebar-item"><a href="reviewManage.sp"
					class='sidebar-link'> <i class="bi bi-blockquote-left"></i> <span>후기
							관리하기</span>
				</a></li>
