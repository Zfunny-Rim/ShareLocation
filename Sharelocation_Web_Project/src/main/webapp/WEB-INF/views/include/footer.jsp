<footer class="bg-light w-100">
	<div class="footer clearfix mb-0 text-muted">
		...
		<div class="float-end p-3">
			<p class="text-muted">
				<font size="2px"> <a href="#">블로그</a> | <a href="#">이용약관</a>
					| <a href="#">개인정보처리방침</a> | <a href="#">운영정책</a> | <a href="#">고객문의</a>
				</font>
			</p>
		</div>
	</div>
	<div class="footer clearfix mb-0 text-muted">
		<div class="float-start p-3">
			<font size="2px"> 상호명: IPS partagé | 대표: 임지훤 | 사업자등록번호:
				105-91-95789 | 통신판매업신고번호: 제 2014-서울마포-1125호 <br> 영업소재지: 서울특별시
				마포구 신촌로 176 | 이메일: hardmix2@gmail.com | 대표전화: 010-4707-4706 <br>
			</font>
		</div>
