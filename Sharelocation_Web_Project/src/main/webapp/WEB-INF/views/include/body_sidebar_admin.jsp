	...
	<div class="sidebar-wrapper">
		...
		<div class="sidebar-menu">
			...
			<ul class="menu">
				...
				<li class="sidebar-item"><a href="main.admin"
					class='sidebar-link'> <i class="bi bi-house-door-fill"></i> <span>홈</span>
				</a></li>
				<li class="sidebar-item"><a href="approvalList.admin"
					class='sidebar-link'> <i class="bi bi-journal-text"></i> <span>검수신청
							리스트</span>
				</a></li>
				<li class="sidebar-item"><a href="spaceList.admin"
